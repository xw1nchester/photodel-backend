...
export class UpdTokenPrimary1771355279026 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "refresh_tokens" DROP CONSTRAINT "PK_4542dd2f38a61354a040ba9fd57"`
        );
        await queryRunner.query(
            `ALTER TABLE "refresh_tokens" ADD CONSTRAINT "PK_b04e52fb0940cbfd2b965bf3ac1" PRIMARY KEY ("token", "id")`
        );
        await queryRunner.query(
            `ALTER TABLE "refresh_tokens" DROP CONSTRAINT "PK_b04e52fb0940cbfd2b965bf3ac1"`
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "refresh_tokens" ADD CONSTRAINT "PK_4542dd2f38a61354a040ba9fd57" PRIMARY KEY ("token")`
        );
        await queryRunner.query(
