...
export class AddCascadeOptionsToLocationFields1772520155257 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "temporary_locations" ADD CONSTRAINT "FK_f8719e9eec2d6b906e3e27aa83d" FOREIGN KEY ("location_id") REFERENCES "locations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "profiles" ADD CONSTRAINT "FK_7a59daf6879b8b1623bace41f54" FOREIGN KEY ("location_id") REFERENCES "locations"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
        );
    }
